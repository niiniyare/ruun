...
## Molecules (views/components/molecules/)
...
## Organisms (views/components/organisms/)
...
## Templates (views/components/templates/)
...
- base_layout.templ
  ...
  - PageLoader()
  - DefaultLoader()
- layout_adapters.templ
  - PageLayoutAdapter()
  - DashboardLayoutAdapter()
- layout_examples.templ
  - ExampleSidebarLayout()
  - ExampleAnalyticsDashboard()
  - ExampleTopbarLayout()
  - ExampleFullscreenLayout()
- dashboard_layout.templ
  - DashboardLayout()
  - AnalyticsDashboard()
  - OverviewDashboard()

## Types (views/components/types.go)
