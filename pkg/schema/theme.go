...
// NewThemeRegistry creates a new theme
func NewThemeRegistry() *ThemeRegistry {
	return &ThemeRegistry{
		themes: make(map[string]*Theme),
	}
}
// Register registers a new theme in the
...
// Delete removes a theme from the
...
// Exists checks if a theme exists in the
...
// BuildAndRegister builds the theme and registers it with the global
