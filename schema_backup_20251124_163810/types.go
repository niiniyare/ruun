...
// Behavior represents HTMX behavior configuration
type Behavior struct {
	// HTTP request configuration
	Get    string `json:"hx_get,omitempty"`
	Post   string `json:"hx_post,omitempty"`
	Put    string `json:"hx_put,omitempty"`
	Patch  string `json:"hx_patch,omitempty"`
	Delete string `json:"hx_delete,omitempty"`
	
	// Response handling
	Target      string `json:"hx_target,omitempty"`
	Swap        string `json:"hx_swap,omitempty"`
	SwapOOB     string `json:"hx_swap_oob,omitempty"`
	Select      string `json:"hx_select,omitempty"`
	SelectOOB   string `json:"hx_select_oob,omitempty"`
	
	// Event triggers
	Trigger     string `json:"hx_trigger,omitempty"`
	From        string `json:"hx_from,omitempty"`
	
	// Request configuration
	Include     string            `json:"hx_include,omitempty"`
	Headers     map[string]string `json:"hx_headers,omitempty"`
	Params      map[string]string `json:"hx_params,omitempty"`
	Values      map[string]string `json:"hx_values,omitempty"`
	
	// Behavior modifiers
	Boost       bool   `json:"hx_boost,omitempty"`
	PushURL     string `json:"hx_push_url,omitempty"`
	ReplaceURL  bool   `json:"hx_replace_url,omitempty"`
	History     bool   `json:"hx_history,omitempty"`
	HistoryElt  string `json:"hx_history_elt,omitempty"`
	
	// UI feedback
	Indicator   string `json:"hx_indicator,omitempty"`
	Disabled    string `json:"hx_disabled,omitempty"`
	Confirm     string `json:"hx_confirm,omitempty"`
	Prompt      string `json:"hx_prompt,omitempty"`
	
	// Advanced features
	Encoding    string `json:"hx_encoding,omitempty"`
	Sync        string `json:"hx_sync,omitempty"`
	Validate    bool   `json:"hx_validate,omitempty"`
	DisableInheritance bool `json:"hx_disable_inheritance,omitempty"`
}
