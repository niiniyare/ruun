...
func AutoComplete(props AutoCompleteProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 1, Col: 0}
		}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 470, Col: 31}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 472, Col: 48}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 478, Col: 20}
		}
		...
		if props.AlpineModel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 481, Col: 51}
			}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 504, Col: 18}
			}
		...
		if props.Placeholder != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 512, Col: 36}
			}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 529, Col: 42}
			}
		...
		if props.AriaLabel != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 533, Col: 33}
			}
		...
		if props.AriaDescribedBy != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 536, Col: 45}
			}
		...
		if props.HXPost != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 539, Col: 27}
			}
		...
		if props.HXGet != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 542, Col: 25}
			}
		...
		if props.HXTarget != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 545, Col: 31}
			}
		...
		if props.HXSwap != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 548, Col: 27}
			}
		...
		if props.HXTrigger != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 551, Col: 33}
			}
		...
		if props.SearchURL != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 554, Col: 29}
			}
			...
			if props.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 557, Col: 45}
				}
			...
			if props.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 561, Col: 48}
				}
		...
		if props.AlpineChange != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 565, Col: 37}
			}
		...
		if props.AlpineBlur != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 568, Col: 33}
			}
		...
		if props.AlpineFocus != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 571, Col: 35}
			}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 595, Col: 31}
			}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 615, Col: 30}
			}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 622, Col: 31}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 661, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/atoms/autocomplete.new.templ`, Line: 670, Col: 25}
		}
