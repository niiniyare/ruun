...
func Badge(props BadgeProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.Clickable || props.OnClick != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 1, Col: 0}
			}
			...
			if props.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 42, Col: 29}
				}
			...
			if props.OnClick != "" {
				...
				var templ_7745c5c3_Var5 templ.ComponentScript = templ.ComponentScript{Call: props.OnClick}
			...
			if props.AriaLabel != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 49, Col: 44}
				}
			...
			if props.AriaDescribedBy != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 52, Col: 56}
				}
			...
			if props.AriaPressed != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 55, Col: 48}
				}
			...
			if props.Text != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 62, Col: 28}
				}
			...
			if props.ID != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 69, Col: 29}
				}
			...
			if props.AriaLabel != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 72, Col: 44}
				}
			...
			if props.AriaDescribedBy != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 75, Col: 56}
				}
			...
			if props.Text != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views_backup_20251127_031632/components/atoms/badge.templ`, Line: 82, Col: 28}
				}
